...
// Obtener los cursos del estudiante con información de asistencia
$sql_cursos = "SELECT c.id_curso, c.nombre_curso, c.descripcion, c.icono,
                ...
                <div class="course-list">
                    ...
                    if ($result_cursos->num_rows > 0):
                        while ($curso = $result_cursos->fetch_assoc()): 
                            $porcentaje_asistencia = $curso['total_clases'] > 0 ? 
                                ($curso['asistencias'] / $curso['total_clases']) * 100 : 0;
                    ?>
                            ...
                            <div class="course-content">
                                <div class="course-details">
                                    ...
                                    <div class="asistencia-resumen">
                                        <p><strong>Total de clases:</strong> <?php echo $curso['total_clases']; ?></p>
                                        <p><strong>Asistencias:</strong> <?php echo $curso['asistencias']; ?></p>
                                        <p><strong>Inasistencias:</strong> <?php echo $curso['inasistencias']; ?></p>
